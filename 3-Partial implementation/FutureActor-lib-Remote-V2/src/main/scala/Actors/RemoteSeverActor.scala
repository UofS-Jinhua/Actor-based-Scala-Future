...
object RemoteSeverActor{
    ...
    case class NewTask[T](ID: Int, func: Array[Byte])
    case class NextTask[T, U](Prev_ID: Int, cur_ID: Int, func: Array[Byte])
    ...
    case class Server_EH_1[T](ID: Int, func: Array[Byte])
    case class Server_EH_2[U](ID: Int, func: Array[Byte])   
