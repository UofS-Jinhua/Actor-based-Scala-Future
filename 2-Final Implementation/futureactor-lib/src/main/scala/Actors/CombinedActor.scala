...
object CombinedWorker{
    ...
    case class FirstResult[T](result: T)             // The first result message
    case class SecondResult[U](result: U)            // The second result message
    case object CombinedResult                       // The combined result message
